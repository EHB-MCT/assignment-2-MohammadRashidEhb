...
namespace StarterAssets
{
    public class StarterAssetsInputs : MonoBehaviour
    {
        ...
        [Header("Interaction")]
        public bool interact; // Only true on frame when pressed
        ...
        {
            // Only set flag on press (not release)
            if (value.isPressed)
            {
        ...
        private void Update()
        {
            // Update public interact flag at start of frame
            interact = _interactPressedThisFrame;
            
            // Immediately reset for next frame
